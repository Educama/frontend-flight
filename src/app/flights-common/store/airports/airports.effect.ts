...
import { AirportService } from "educama-frontend-shared";
  ...
  @Effect() loadAirports = this._actions
                               ...
                               .pipe(
                                 ...
                                 switchMap((airportListSlice: AirportSlice) => {
                                   return this._airportService.findAirports(environment.apiBaseUrl,
                                     airportListSlice.pageNumber, airportListSlice.pageSize, this._store,
