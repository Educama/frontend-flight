...
import { AirlineService } from "educama-frontend-shared";
  ...
  @Effect() loadAirlines = this._actions
                               ...
                               .pipe(
                                 ...
                                 switchMap((airlineListSlice: AirlineSlice) => {
                                   return this._airlineService.findAirlines(environment.apiBaseUrl,
                                     airlineListSlice.pageNumber, airlineListSlice.pageSize, this._store,
